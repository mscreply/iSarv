...
namespace iSarv.Migrations
{
    ...
    [Migration("20250730124330_afterChangeIsCompletedForTests")]
    partial class afterChangeIsCompletedForTests
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("iSarv.Data.Services.AISetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("iSarv.Data.Services.Prompt", b =>
                {
                    b.Property<string>("Name")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("iSarv.Data.Tests.HollandTest", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("HollandTests");
                });

            modelBuilder.Entity("iSarv.Data.Tests.HollandTestQuestion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<int>("HollandPersonality")
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("HollandTestQuestions");
                });
            ...
            modelBuilder.Entity("iSarv.Data.Tests.RavenTest", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("iSarv.Data.Tests.HollandTest", b =>
                {
                    b.HasOne("iSarv.Data.Tests.TestPackage", "TestPackage")
                        .WithOne("HollandTest")
                        .HasForeignKey("iSarv.Data.Tests.HollandTest", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("iSarv.Data.Tests.RavenTest", b =>
                {
                    b.HasOne("iSarv.Data.Tests.TestPackage", "TestPackage")
                        .WithOne("RavenTest")
                        .HasForeignKey("iSarv.Data.Tests.RavenTest", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("iSarv.Data.Tests.TestPackage", b =>
                {
                    ...
                    b.Navigation("HollandTest");

                    b.Navigation("NeoTest");

                    b.Navigation("RavenTest")
                        .IsRequired();
                });
